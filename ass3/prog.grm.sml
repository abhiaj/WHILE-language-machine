...
\\040\000\013\000\041\000\037\000\042\000\036\000\000\000\
...
\\112\000\000\000\
\\113\000\000\000\
\\114\000\021\000\062\000\000\000\
\\115\000\000\000\
\\116\000\022\000\061\000\000\000\
\\117\000\000\000\
\\118\000\000\000\
\\119\000\030\000\060\000\031\000\059\000\000\000\
\\120\000\000\000\
\\121\000\000\000\
\\122\000\000\000\
\\123\000\000\000\
\\124\000\026\000\058\000\027\000\057\000\028\000\056\000\029\000\055\000\000\000\
\\125\000\000\000\
\\126\000\000\000\
\\127\000\032\000\054\000\033\000\053\000\000\000\
\\128\000\000\000\
\\129\000\000\000\
\\130\000\000\000\
\\131\000\034\000\052\000\035\000\051\000\036\000\050\000\000\000\
\\132\000\000\000\
\\133\000\000\000\
\\134\000\000\000\
\\135\000\000\000\
...
"\001\000\024\000\002\000\028\000\
\\028\000\005\000\033\000\027\000\
\\035\000\032\000\003\000\069\000\
\\013\000\021\000\009\000\019\000\
\\025\000\019\000\019\000\033\000\
\\004\000\019\000\035\000\026\000\
\\063\000\060\000\056\000\053\000\
\\048\000\045\000\043\000\041\000\
\\038\000\064\000\019\000\065\000\
\\019\000\067\000\066\000\019\000\
\\037\000\017\000\014\000\031\000\
\\022\000\023\000\036\000\034\000\
\\019\000\019\000\019\000\019\000\
\\019\000\019\000\019\000\019\000\
\\019\000\019\000\019\000\019\000\
\\019\000\061\000\062\000\020\000\
\\006\000\007\000\030\000\029\000\
\\059\000\058\000\057\000\055\000\
\\054\000\050\000\052\000\049\000\
\\051\000\047\000\046\000\044\000\
\\042\000\068\000\035\000\035\000\
\\010\000\011\000\018\000\015\000\
\\040\000\008\000\035\000\012\000\
\\016\000\039\000\000\000"
val gotoT =
"\
...
\\011\000\029\000\012\000\028\000\013\000\027\000\014\000\026\000\
\\015\000\025\000\016\000\024\000\000\000\
\\006\000\043\000\007\000\009\000\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\007\000\033\000\014\000\068\000\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\014\000\069\000\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\014\000\070\000\015\000\025\000\016\000\024\000\000\000\
...
\\016\000\024\000\000\000\
\\007\000\033\000\012\000\073\000\013\000\027\000\014\000\026\000\
\\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\012\000\074\000\013\000\027\000\014\000\026\000\
\\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\012\000\075\000\013\000\027\000\014\000\026\000\
\\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\012\000\076\000\013\000\027\000\014\000\026\000\
\\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\011\000\077\000\012\000\028\000\013\000\027\000\
\\014\000\026\000\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\011\000\078\000\012\000\028\000\013\000\027\000\
\\014\000\026\000\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\010\000\079\000\011\000\029\000\012\000\028\000\
\\013\000\027\000\014\000\026\000\015\000\025\000\016\000\024\000\000\000\
\\007\000\033\000\009\000\080\000\010\000\030\000\011\000\029\000\
...
, _, _)) :: _ :: ( _, ( MlyValue.IDENTIFIER IDENTIFIER, _, _)) :: ( _,
 ( _, PROGRAM1left, _)) :: rest671)) => let val  result = 
MlyValue.start (AST.PROG(IDENTIFIER, declarations, commandlist))
...
|  ( 16, ( ( _, ( MlyValue.or_exp or_exp, _, or_exp1right)) :: ( _, (
 _, ORleft, _)) :: ( _, ( MlyValue.and_exp and_exp, and_exp1left, _))
 :: rest671)) => let val  result = MlyValue.or_exp (
if check_bexp2(and_exp, or_exp) then AST.OR(and_exp, or_exp) else (exit_prog ORleft; AST.ERROR)
)
 in ( LrTable.NT 8, ( result, and_exp1left, or_exp1right), rest671)
...
|  ( 18, ( ( _, ( MlyValue.and_exp and_exp, _, and_exp1right)) :: ( _,
 ( _, ANDleft, _)) :: ( _, ( MlyValue.eq_exp eq_exp, eq_exp1left, _))
 :: rest671)) => let val  result = MlyValue.and_exp (
if check_bexp2(eq_exp, and_exp) then AST.AND(eq_exp, and_exp) else (exit_prog ANDleft; AST.ERROR)
)
 in ( LrTable.NT 9, ( result, eq_exp1left, and_exp1right), rest671)
...
|  ( 20, ( ( _, ( MlyValue.eq_exp eq_exp, _, eq_exp1right)) :: ( _, (
 _, EQleft, _)) :: ( _, ( MlyValue.rel_exp rel_exp, rel_exp1left, _))
 :: rest671)) => let val  result = MlyValue.eq_exp (
if check_i2_b2(rel_exp, eq_exp) then AST.EQ(rel_exp, eq_exp) else (exit_prog EQleft; AST.ERROR)
)
 in ( LrTable.NT 10, ( result, rel_exp1left, eq_exp1right), rest671)

end
|  ( 21, ( ( _, ( MlyValue.eq_exp eq_exp, _, eq_exp1right)) :: ( _, (
 _, NEQleft, _)) :: ( _, ( MlyValue.rel_exp rel_exp, rel_exp1left, _))
 :: rest671)) => let val  result = MlyValue.eq_exp (
if check_i2_b2(rel_exp, eq_exp) then AST.NEQ(rel_exp, eq_exp) else (exit_prog NEQleft; AST.ERROR)
)
 in ( LrTable.NT 10, ( result, rel_exp1left, eq_exp1right), rest671)
...
|  ( 23, ( ( _, ( MlyValue.rel_exp rel_exp, _, rel_exp1right)) :: ( _,
 ( _, GTleft, _)) :: ( _, ( MlyValue.add_exp add_exp, add_exp1left, _)
) :: rest671)) => let val  result = MlyValue.rel_exp (
if check_i2_b2(add_exp, rel_exp) then AST.GT(add_exp, rel_exp) else (exit_prog GTleft; AST.ERROR)
)
 in ( LrTable.NT 11, ( result, add_exp1left, rel_exp1right), rest671)

end
|  ( 24, ( ( _, ( MlyValue.rel_exp rel_exp, _, rel_exp1right)) :: ( _,
 ( _, GTEleft, _)) :: ( _, ( MlyValue.add_exp add_exp, add_exp1left, _
)) :: rest671)) => let val  result = MlyValue.rel_exp (
if check_i2_b2(add_exp, rel_exp) then AST.GTE(add_exp, rel_exp) else (exit_prog GTEleft; AST.ERROR)
)
 in ( LrTable.NT 11, ( result, add_exp1left, rel_exp1right), rest671)

end
|  ( 25, ( ( _, ( MlyValue.rel_exp rel_exp, _, rel_exp1right)) :: ( _,
 ( _, LTleft, _)) :: ( _, ( MlyValue.add_exp add_exp, add_exp1left, _)
) :: rest671)) => let val  result = MlyValue.rel_exp (
if check_i2_b2(add_exp, rel_exp) then AST.LT(add_exp, rel_exp) else (exit_prog LTleft; AST.ERROR)
)
 in ( LrTable.NT 11, ( result, add_exp1left, rel_exp1right), rest671)

end
|  ( 26, ( ( _, ( MlyValue.rel_exp rel_exp, _, rel_exp1right)) :: ( _,
 ( _, LTEleft, _)) :: ( _, ( MlyValue.add_exp add_exp, add_exp1left, _
)) :: rest671)) => let val  result = MlyValue.rel_exp (
if check_i2_b2(add_exp, rel_exp) then AST.LTE(add_exp, rel_exp) else (exit_prog LTEleft; AST.ERROR)
)
 in ( LrTable.NT 11, ( result, add_exp1left, rel_exp1right), rest671)
...
|  ( 31, ( ( _, ( MlyValue.mult_exp mult_exp, _, mult_exp1right)) :: (
 _, ( _, MULleft, _)) :: ( _, ( MlyValue.unary_exp unary_exp, 
unary_exp1left, _)) :: rest671)) => let val  result = 
MlyValue.mult_exp (
if check_iexp2(unary_exp, mult_exp)=true  then AST.TIMES(unary_exp, mult_exp) else (exit_prog MULleft; AST.ERROR)
)
 in ( LrTable.NT 13, ( result, unary_exp1left, mult_exp1right), 
rest671)
end
|  ( 32, ( ( _, ( MlyValue.mult_exp mult_exp, _, mult_exp1right)) :: (
 _, ( _, DIVleft, _)) :: ( _, ( MlyValue.unary_exp unary_exp, 
unary_exp1left, _)) :: rest671)) => let val  result = 
MlyValue.mult_exp (
if check_iexp2(unary_exp, mult_exp)=true  then AST.DIV(unary_exp, mult_exp) else (exit_prog DIVleft; AST.ERROR)
)
 in ( LrTable.NT 13, ( result, unary_exp1left, mult_exp1right), 
rest671)
end
|  ( 33, ( ( _, ( MlyValue.mult_exp mult_exp, _, mult_exp1right)) :: (
 _, ( _, MODleft, _)) :: ( _, ( MlyValue.unary_exp unary_exp, 
unary_exp1left, _)) :: rest671)) => let val  result = 
MlyValue.mult_exp (
if check_iexp2(unary_exp, mult_exp)=true  then AST.MOD(unary_exp, mult_exp) else (exit_prog MODleft; AST.ERROR)
)
 in ( LrTable.NT 13, ( result, unary_exp1left, mult_exp1right), 
rest671)
end
